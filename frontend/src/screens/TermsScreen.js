...
Farely provides tools to compare ride options, view estimates, book simulated rides, and receive in-app notifications. Features may change for testing, demonstration, or academic purposes (e.g. FYP projects).
...
4. Payments
Fare amounts shown are estimates unless stated otherwise. Final charges may depend on the provider’s app or policies. The App does not process real payments; it is intended for comparison and simulation.
